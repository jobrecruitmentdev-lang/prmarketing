...
describe("site config", () => {
  ...
  it("whatsapp has valid digits and wa.me URL format", () => {
    expect(site.whatsappNumber).toMatch(/^\d{10,15}$/);
    expect(site.whatsappUrl).toContain(`https://wa.me/${site.whatsappNumber}`);
  });
});
