    ...
    <form onSubmit={handleSubmit} className="space-y-5" noValidate={false}>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div>
          ...
          <select id="service" name="service" required className={`${inputCls} cursor-pointer`} defaultValue="">
      ...
      {sent && (
        <p role="status" className="rounded-lg bg-amber-50 p-4 text-sm text-accent-dark break-words leading-relaxed">
          Your email app should have opened with the enquiry pre-filled — just
          press send. If it didn&rsquo;t, email us directly at{" "}
          <a href={`mailto:${site.email}`} className="font-semibold underline break-all">
            {site.email}
          </a>
          .
        </p>
