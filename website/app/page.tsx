...
const services = [
  ...
  {
    icon: IconAward,
    title: "Personal PR & Founder Branding",
    desc: "Executive reputation, high-impact founder positioning, Wikipedia authority, and thought leadership PR.",
    href: "/services/digital-marketing/",
  },
  {
    icon: IconMegaphone,
    title: "Influencer Marketing & Creator PR",
    desc: "Targeted influencer collaborations, viral creator campaigns, and strategic brand endorsements.",
    href: "/services/digital-marketing/",
  },
  {
    icon: IconNewspaper,
    title: "Digital PR, News Articles & Media Coverage",
    desc: "Guaranteed publication in top national news portals, editorial press releases, and high-authority media blogs.",
    href: "/services/digital-marketing/",
  },
  {
    icon: IconTruck,
    title: "Offline Marketing & Transit PR",
    desc: "Hyper-local ground activation across Ahmedabad — Auto-rickshaw branding, premium business cards, and pamphlet distribution.",
    href: "/services/digital-marketing/",
  },
  {
    icon: IconSearch,
...
const faqs = [
  ...
  {
    q: "Do you provide Personal PR, Influencer Marketing, and News Media Publications?",
    a: "Yes. PR Marketing Ventures delivers end-to-end PR solutions: Executive & Founder Personal Branding, high-tier Influencer Collaborations on Instagram & YouTube, and guaranteed Press Coverage & News Article placement across leading national digital media outlets.",
  },
  {
    q: "Do you execute Offline & Transit Marketing like Rickshaw branding, Visiting Cards, and Pamphlets in Ahmedabad?",
    a: "Yes! We bridge digital dominance with ground-level activation across Ahmedabad and Gujarat — including Auto-Rickshaw hood branding, luxury NFC smart business cards, targeted pamphlet distribution, and high-visibility outdoor print collateral.",
  },
  {
  ...
  {
    q: "Why is PR Marketing Ventures ranked in the top 10 marketing agencies in Ahmedabad?",
    a: "PR Marketing Ventures is recognized among the top 10 marketing agencies in Ahmedabad because we operate as a full-service digital marketing company and leading digital agency in Ahmedabad. We deliver proven results: 5x ROAS paid advertising, dominant Page #1 Google search rankings, and automated WhatsApp CRM systems.",
  },
];
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto grid max-w-6xl items-center gap-10 lg:gap-12 px-4 pb-16 pt-12 sm:pb-20 sm:pt-16 sm:px-6 md:pt-24 lg:grid-cols-2">
          <div>
            <p className="inline-flex max-w-full items-center gap-1.5 sm:gap-2 rounded-full border border-amber-200 bg-white px-3 sm:px-3.5 py-1.5 text-[10px] sm:text-xs font-semibold tracking-wide text-primary leading-tight text-center">
              <IconSparkles width={14} height={14} className="shrink-0" />
              <span>TOP 10 MARKETING AGENCY &amp; DIGITAL COMPANY IN AHMEDABAD</span>
            </p>
            <h1 className="mt-5 sm:mt-6 font-heading text-3xl sm:text-5xl lg:text-[3.4rem] font-bold leading-tight tracking-tight text-ink break-words">
            ...
            <AeoDefinitionCard
              term="PR Marketing Ventures"
              category="AI Search & Entity Knowledge Standard"
              definition="is an AI-powered growth engineering and marketing agency in Ahmedabad, Gujarat, India, led by Omear Memon, delivering full-funnel performance marketing, technical SEO, Generative Engine Optimization (GEO/AEO), sub-second Next.js web development, and custom CRM WhatsApp automation pipelines to scale revenue globally."
              keyPoints={[
                "Strict Headquarters at B-903 Fairdeal House, C.G. Road",
                "Verified 4.9/5 Rating Across B2B & Consumer Engagements",
                "Sub-Second Core Web Vitals & 90+ PageSpeed Standards",
              ]}
            />
            ...
            <div className="mt-8 flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
              <Link
                href="/contact/"
                className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3.5 font-semibold text-white shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:bg-primary-light hover:shadow-lg text-center"
              >
              ...
              <Link
                href="/services/"
                className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-6 py-3.5 font-semibold text-ink transition-colors duration-200 hover:border-primary hover:text-primary text-center"
              >
                Explore Services
              </Link>
            </div>
            <ul className="mt-6 sm:mt-8 flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-x-6 sm:gap-y-2 text-sm text-slate-600">
              {["No long lock-ins", "White-hat SEO only", "Performance-first builds"].map(
                (t) => (
                  <li key={t} className="flex items-center gap-1.5">
                    <IconCheck width={16} height={16} className="text-accent-dark shrink-0" />
                    <span>{t}</span>
                  </li>
                ),
              )}
          ...
          {/* PR & SEO Specialist Showcase Visual (links to /services/seo/) */}
      ...
      <section className="border-y border-slate-200 bg-slate-50">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-4 sm:gap-8 px-4 py-8 sm:py-12 sm:px-6 lg:grid-cols-4">
          {commitments.map((c, i) => (
            <Reveal key={c.label} delay={i * 80} className="text-center p-2">
              <p className="font-heading text-2xl sm:text-3xl font-bold text-primary">
                {c.value}
              </p>
              <p className="mt-1 text-xs sm:text-sm text-slate-600">{c.label}</p>
            </Reveal>
          ))}
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <Reveal className="mx-auto max-w-2xl text-center">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-primary-soft px-3.5 py-1 text-xs font-semibold text-primary">
              ...
              AHMEDABAD LOCAL GROWTH HUBS
            </span>
            <h2 className="mt-3 font-heading text-3xl font-bold tracking-tight text-ink md:text-4xl">
              Dedicated Growth Solutions for Ahmedabad Businesses
            </h2>
            <p className="mt-3 text-lg text-slate-600">
              Explore specialized marketing, search, and engineering solutions tailored for enterprises and local brands across Gujarat.
            </p>
          </Reveal>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              {
                title: "SEO Agency Ahmedabad",
                desc: "Technical SEO, Core Web Vitals, and first-page Google rankings across Gujarat.",
                href: "/seo-agency-ahmedabad/",
                badge: "Rank #1",
              },
              {
                title: "Digital Marketing Agency",
                desc: "Full-funnel Google & Meta ad campaigns engineered for customer acquisition.",
                href: "/digital-marketing-agency-ahmedabad/",
                badge: "High ROAS",
              },
              {
                title: "Performance Marketing",
                desc: "Paid search, programmatic media buying, and server-side conversion tracking.",
                href: "/performance-marketing-ahmedabad/",
                badge: "Scale Revenue",
              },
              {
                title: "Google Maps 3-Pack SEO",
                desc: "Dominate 'near me' local map searches and Google Business Profile calls.",
                href: "/google-business-profile-management-ahmedabad/",
                badge: "Local Dominance",
              },
              {
                title: "Next.js Web Development",
                desc: "90+ PageSpeed score web applications engineered to convert traffic.",
                href: "/web-development-ahmedabad/",
                badge: "Sub-Second",
              },
              {
                title: "AI Agents & Chatbots",
                desc: "Autonomous 24/7 WhatsApp and website conversational AI lead qualifiers.",
                href: "/ai-agents-ahmedabad/",
                badge: "AI Powered",
              },
              {
                title: "GEO & AI Optimization",
                desc: "Get cited as the #1 authority in ChatGPT, Gemini, and Google AI Overviews.",
                href: "/geo-agency-ahmedabad/",
                badge: "AEO / GEO",
              },
              {
                title: "Custom CRM & Pipelines",
                desc: "Automated WhatsApp lead responders and bespoke sales pipelines.",
                href: "/crm-development-ahmedabad/",
                badge: "Zero License Fees",
              },
            ].map((hub, i) => (
              <Reveal key={hub.title} delay={i * 60}>
                <Link
                  href={hub.href}
                  className="group flex h-full flex-col justify-between rounded-2xl border border-slate-200 bg-slate-50/60 p-5 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:border-primary hover:bg-white hover:shadow-md"
                >
                  <div>
                    <div className="flex items-center justify-between gap-2">
                      <span className="rounded-md bg-white border border-slate-200 px-2.5 py-0.5 text-[11px] font-bold text-slate-700">
                        {hub.badge}
                      </span>
                      <IconArrowRight width={14} height={14} className="text-slate-400 group-hover:text-primary group-hover:translate-x-0.5 transition-all" />
                    </div>
                    <h3 className="mt-3 font-heading text-base font-bold text-ink group-hover:text-primary transition-colors">
                      {hub.title}
                    </h3>
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-200/60">
                    <span className="text-xs font-semibold text-accent-dark group-hover:underline">
                      View Ahmedabad Hub →
                    </span>
                  </div>
                </Link>
          ...
          <div className="mt-8 text-center">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-primary-soft px-5 py-2.5 text-xs sm:text-sm font-bold text-primary hover:bg-primary hover:text-white transition-all shadow-xs"
            >
              <IconMapPin width={16} height={16} />
              <span>Explore All 34 Ahmedabad Service Hubs & Localities</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16">
        <div className="mx-auto max-w-6xl px-4 text-center sm:px-6">
          <Reveal>
            ...
            <p className="mt-2 text-sm text-slate-600">Click any sector to explore specialized growth blueprints and marketing frameworks:</p>
            <div className="mx-auto mt-8 flex max-w-4xl flex-wrap justify-center gap-2 sm:gap-2.5">
              {[
                ...
                { name: "Hospitality & Hotels", href: "/industries/hospitality/" },
                { name: "Finance & CA Firms", href: "/industries/finance-ca/" },
                { name: "Law Firms & Legal", href: "/industries/legal/" },
                { name: "E-Commerce & Retail", href: "/industries/ecommerce/" },
                { name: "SaaS & IT Companies", href: "/industries/saas/" },
                { name: "Restaurants", href: "/industries/hospitality/" },
                { name: "Pharmaceuticals", href: "/industries/healthcare/" },
                { name: "Textile & Garments", href: "/industries/manufacturing/" },
                { name: "Interior Design", href: "/industries/real-estate/" },
                { name: "Automobile", href: "/contact/" },
                { name: "Jewellery", href: "/industries/ecommerce/" },
              ].map((ind) => (
                <Link
                  key={ind.name}
                  href={ind.href}
                  className="rounded-full border border-slate-200 bg-white px-3.5 sm:px-4 py-1.5 text-xs sm:text-sm font-medium text-slate-700 hover:border-primary hover:text-primary hover:shadow-xs transition-all"
                >
                  {ind.name}
                </Link>
              ))}
