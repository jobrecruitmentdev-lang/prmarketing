...
export const metadata: Metadata = {
  title: "B2B Marketing Agency in Ahmedabad | PR Marketing Co.",
  description:
    "Acquire qualified enterprise leads with PR Marketing Ventures, Ahmedabad's top B2B marketing agency. High-ROI LinkedIn Ads, ABM campaigns, and organic SEO.",
