...
export const metadata: Metadata = {
  title: "Performance Marketing in Ahmedabad | PR Marketing Co.",
  description:
    "Scale revenue with high-ROAS performance marketing in Ahmedabad by PR Marketing Ventures. Full-funnel Meta Ads, Google Ads, and landing page CRO that converts.",
