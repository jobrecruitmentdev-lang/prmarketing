...
export const metadata: Metadata = {
  title: "Top SEO Agency in Ahmedabad | PR Marketing Ventures",
  description:
    "Accelerate organic growth with the top SEO agency in Ahmedabad. PR Marketing Ventures delivers technical on-page SEO, speed optimization, and top SERP ranks.",
