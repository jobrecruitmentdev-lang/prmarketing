...
export const metadata: Metadata = {
  title: "Pharma Marketing Agency Ahmedabad | PR Marketing Co.",
  description:
    "Compliant pharmaceutical and healthcare marketing with PR Marketing Ventures in Ahmedabad. Medical SEO, doctor engagement, and B2B pharma lead generation.",
