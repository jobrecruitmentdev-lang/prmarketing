...
export const metadata: Metadata = {
  title: "Ecommerce Development Company Ahmedabad | PR Marketing",
  description:
    "Launch scalable online stores with PR Marketing Ventures in Ahmedabad. Custom Shopify and Next.js ecommerce web development engineered for high sales volume.",
