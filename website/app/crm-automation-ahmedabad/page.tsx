...
export const metadata: Metadata = {
  title: "CRM Automation Agency in Ahmedabad | PR Marketing Co",
  description:
    "Supercharge sales teams with CRM automation by PR Marketing Ventures in Ahmedabad. Automated lead assignment, WhatsApp sequences, and deal pipeline tracking.",
