...
export const metadata: Metadata = {
  title: "Software Development Company Ahmedabad | PR Marketing",
  description:
    "Build bespoke web apps, APIs, and enterprise software with PR Marketing Ventures in Ahmedabad. Robust full-stack engineering tailored to business goals.",
