...
export const metadata: Metadata = {
  title: "Top AI Marketing Agency Ahmedabad | PR Marketing Co.",
  description:
    "Transform your marketing using artificial intelligence. PR Marketing Ventures in Ahmedabad builds automated AI ad funnels, predictive targeting, and GEO search.",
