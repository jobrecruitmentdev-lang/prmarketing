...
export const metadata: Metadata = {
  ...
  description:
    "Drive profitable growth with PR Marketing Ventures, Ahmedabad's top performance marketing agency. We optimize Google, Meta, and native ad spend for maximum ROI.",
