...
export const metadata: Metadata = {
  title: "AI Business Automation in Ahmedabad | PR Marketing Co.",
  description:
    "Automate routine operations, sales follow-ups, and customer workflows with PR Marketing Ventures in Ahmedabad. AI-driven automation built to save hours daily.",
