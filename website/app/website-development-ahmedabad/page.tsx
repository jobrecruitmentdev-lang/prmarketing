...
export const metadata: Metadata = {
  title: "Website Development Company Ahmedabad | PR Marketing Co",
  description:
    "Build custom Next.js and WordPress websites in Ahmedabad with PR Marketing Ventures. Fast loading, responsive, SEO-ready, and conversion-engineered for growth.",
