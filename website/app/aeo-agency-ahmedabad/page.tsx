...
export const metadata: Metadata = {
  title: "AEO Agency in Ahmedabad | Answer Engine Optimization",
  description:
    "Get cited in voice and AI search engines with PR Marketing Ventures, Ahmedabad's top AEO agency. We optimize semantic schema, FAQs, and conversational queries.",
