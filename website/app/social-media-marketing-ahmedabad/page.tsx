...
export const metadata: Metadata = {
  title: "Social Media Marketing in Ahmedabad | PR Marketing Co.",
  description:
    "Dominate Instagram, LinkedIn, and Facebook in Ahmedabad with PR Marketing Ventures. Viral content creation, influencer tie-ups, and targeted customer ads.",
