...
export const metadata: Metadata = {
  title: "Google Business Profile Management | PR Marketing Co.",
  description:
    "Dominate local Google Map pack searches with PR Marketing Ventures in Ahmedabad. Professional GBP listing management, local citations, and review growth.",
