...
export const metadata: Metadata = {
  title: "Law Firm & Lawyer Digital Marketing | PR Marketing Co",
  description:
    "Acquire high-value legal clients with PR Marketing Ventures in Ahmedabad. Ethical law firm SEO, Google Business Profile optimization, and local reputation PR.",
