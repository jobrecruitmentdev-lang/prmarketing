...
export const metadata: Metadata = {
  title: "Real Estate Marketing Agency Ahmedabad | PR Marketing",
  description:
    "Generate qualified property buyers and site visits with PR Marketing Ventures in Ahmedabad. Digital marketing, Meta ads, and Google PPC built for developers.",
