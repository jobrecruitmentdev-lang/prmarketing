...
export const metadata: Metadata = {
  title: "Hotel & Restaurant Marketing Agency | PR Marketing Co",
  description:
    "Drive table reservations and direct room bookings with PR Marketing Ventures in Ahmedabad. Local Google 3-Pack SEO, food influencer PR, and social media ads.",
