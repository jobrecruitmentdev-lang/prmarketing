...
export const metadata: Metadata = {
  title: "Education Digital Marketing Agency | PR Marketing Co.",
  description:
    "Boost student admissions for schools, colleges, and coaching institutes with PR Marketing Ventures in Ahmedabad. Targeted Google Ads, Meta ads, and local SEO.",
