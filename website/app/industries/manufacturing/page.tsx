...
export const metadata: Metadata = {
  title: "Manufacturing Marketing Agency Ahmedabad | PR Marketing",
  description:
    "Drive domestic and export trade inquiries for manufacturing units with PR Marketing Ventures in Ahmedabad. Industrial SEO, Google Ads, and custom CRM systems.",
