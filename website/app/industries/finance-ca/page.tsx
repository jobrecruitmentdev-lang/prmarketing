...
export const metadata: Metadata = {
  title: "Finance & CA Marketing Agency Ahmedabad | PR Marketing",
  description:
    "Acquire high-net-worth clients for chartered accountants and fintech firms in Ahmedabad. Compliant financial SEO, Google PPC ads, and local reputation building.",
