...
export const metadata: Metadata = {
  title: "Google Ads Agency Ahmedabad | High ROAS PPC Campaigns",
  description:
    "Scale sales with PR Marketing Ventures, the leading Google Ads agency in Ahmedabad. We build high-converting PPC search, display, and YouTube campaigns daily.",
