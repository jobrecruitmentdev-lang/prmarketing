...
export const metadata: Metadata = {
  title: "GEO Agency in Ahmedabad | Generative Engine Ranking",
  description:
    "Dominate generative AI search platforms with PR Marketing Ventures, the top GEO agency in Ahmedabad. Optimize your entity authority across ChatGPT & Perplexity.",
