...
export const metadata: Metadata = {
  title: "Ecommerce Website Development Ahmedabad | PR Marketing",
  description:
    "Get high-converting ecommerce websites built with PR Marketing Ventures in Ahmedabad. Fast checkout, mobile-first design, payment gateways, and SEO included.",
