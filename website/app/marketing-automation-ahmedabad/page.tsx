...
export const metadata: Metadata = {
  ...
  description:
    "Automate customer acquisition and nurturing with PR Marketing Ventures in Ahmedabad. Custom WhatsApp API workflows, CRM integration, and email autoresponders.",
