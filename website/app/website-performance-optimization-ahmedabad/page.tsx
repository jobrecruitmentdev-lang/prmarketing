...
export const metadata: Metadata = {
  ...
  description:
    "Boost website speed to sub-second load times with PR Marketing Ventures in Ahmedabad. Complete Core Web Vitals fixes, server caching, and PageSpeed 90+ score.",
