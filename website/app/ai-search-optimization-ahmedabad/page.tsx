...
export const metadata: Metadata = {
  title: "AI Search Optimization in Ahmedabad | PR Marketing Co",
  description:
    "Rank your business in ChatGPT, Perplexity, and Google AI Overviews with PR Marketing Ventures in Ahmedabad. Dominate conversational generative search today!",
