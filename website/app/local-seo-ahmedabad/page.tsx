...
export const metadata: Metadata = {
  title: "Local SEO Agency Ahmedabad | Rank #1 on Google Maps",
  description:
    "Dominate Ahmedabad local search results with PR Marketing Ventures. We optimize Google Maps 3-Pack, local business citations, and geo-targeted keywords fast.",
