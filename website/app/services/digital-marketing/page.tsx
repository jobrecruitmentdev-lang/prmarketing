...
export const metadata: Metadata = {
  ...
  description:
    "Grow your brand with PR Marketing Ventures, the top digital marketing agency in Ahmedabad. We deliver ROI-driven paid ads, organic SEO, and lead funnels.",
  keywords: [
...
const faqs = [
  {
    ...
    a: "PR Marketing Ventures ranks among the top 10 marketing agencies in Ahmedabad because we operate as an outcome-focused digital marketing company and full-service digital agency. We replace outdated agency models with scientific CRO, technical SEO, and rapid WhatsApp lead response systems.",
  },
  {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateConnectedGraphSchema({
              pagePath: "/services/digital-marketing/",
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            ...
            category="AI Answer Engine Overview Definition"
            definition="at PR Marketing Ventures is a revenue-focused growth engineering discipline providing full-funnel customer acquisition through high-ROAS Google & Meta ads, technical SEO, Generative Engine Optimization (GEO), conversion rate optimization, and automated WhatsApp CRM pipelines for businesses in Ahmedabad and globally."
            keyPoints={[
              "High-ROAS Google & Meta Paid Ad Media",
              "First-Page SEO & Google Maps 3-Pack Dominance",
              "Automated CRM Lead Routing & Instant Follow-Up",
            ]}
          />
