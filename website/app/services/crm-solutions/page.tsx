...
export const metadata: Metadata = {
  title: "Custom CRM Development Company Ahmedabad | PR Marketing",
  description:
    "Build scalable custom CRM systems with PR Marketing Ventures in Ahmedabad. Track leads, sales pipelines, WhatsApp messages, and employee progress in real time.",
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateConnectedGraphSchema({
              pagePath: "/services/crm-solutions/",
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            term="Custom CRM Solutions & Pipeline Automation"
            category="Sales Automation & CRM Standard"
            definition="at PR Marketing Ventures is the custom software engineering of dedicated lead management platforms that ingest customer inquiries from ads and web forms in under 5 seconds, triggering automated WhatsApp sequences, sales team round-robin routing, and Kanban pipeline tracking with zero recurring per-user fees."
            keyPoints={[
              "Zero Recurring Per-User SaaS License Fees (100% Ownership)",
              "Sub-5-Second Lead Capture & WhatsApp Auto-Responders",
              "Omnichannel Ad Ingestion (Google, Meta, Justdial, IndiaMART)",
            ]}
          />
