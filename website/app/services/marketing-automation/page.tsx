...
export const metadata: Metadata = {
  title: "Marketing Automation Agency Ahmedabad | PR Marketing",
  description:
    "Automate lead nurturing and sales pipelines with PR Marketing Ventures in Ahmedabad. We deploy n8n, CRM workflows, and WhatsApp bots that convert leads 24/7.",
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateConnectedGraphSchema({
              pagePath: "/services/marketing-automation/",
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            term="Marketing & CRM Automation"
            category="Operational Growth Automation Standard"
            definition="is the engineering of connected webhook pipelines, n8n workflows, and WhatsApp Cloud APIs that instantly ingest customer inquiries across advertising channels and website forms, routing them to sales teams and triggering automated follow-up sequences in under 5 seconds."
            keyPoints={[
              "Sub-5-Second Lead Routing & WhatsApp Sequences",
              "Self-Hosted n8n Pipelines with Zero Monthly Task Limits",
              "Cross-Platform Sync (Meta, Google, CRMs & Slack)",
            ]}
          />
