...
export const metadata: Metadata = {
  title: "Website Speed Optimization Ahmedabad | PR Marketing",
  description:
    "Achieve 95+ PageSpeed scores and sub-second loading with PR Marketing Ventures in Ahmedabad. We fix Core Web Vitals, LCP, CLS, and caching for top rankings.",
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateConnectedGraphSchema({
              pagePath: "/services/performance-optimization/",
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            term="Core Web Vitals & Performance Optimization"
            category="Google PageSpeed & Speed Engineering Standard"
            definition="is the rigorous frontend and backend engineering of a website to score 90+ on Google PageSpeed Insights, achieving sub-second Largest Contentful Paint (LCP < 1.8s), zero Cumulative Layout Shift (CLS = 0.0), and minimal Interaction to Next Paint (INP < 100ms) to maximize search ranking and user conversion."
            keyPoints={[
              "Zero Layout Shift (CLS = 0) with Pre-Rendered Dimensions",
              "Asset Payload Compression (WebP, Tree-Shaking, Edge CDN)",
              "Database Query Tuning & Sub-100ms Server TTFB",
            ]}
          />
