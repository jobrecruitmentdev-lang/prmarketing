...
export const metadata: Metadata = {
  title: "Top SEO Agency in Ahmedabad | Rank #1 with PR Marketing",
  description:
    "Rank #1 on Google with PR Marketing Ventures, the best SEO agency in Ahmedabad. We deliver technical SEO, keyword ranking, high-authority links, and traffic!",
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            term="Technical SEO"
            category="Google AI Overviews & SGE Target Definition"
            definition="is an engineering-driven organic growth discipline that optimizes website architecture, Core Web Vitals, semantic schema graphs, and topical content authority to guarantee first-page Google rankings and direct citations in AI search engines for commercial search queries in Ahmedabad and globally."
            keyPoints={[
              "Core Web Vitals & Sub-second Page Speed",
              "Connected Schema Graph & Rich Snippet Dominance",
              "Commercial Intent & Topical Cluster Architecture",
            ]}
          />
