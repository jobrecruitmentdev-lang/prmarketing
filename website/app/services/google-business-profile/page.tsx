...
export const metadata: Metadata = {
  title: "Google Business Profile Agency Ahmedabad | PR Marketing",
  description:
    "Dominate Google Maps 3-pack with PR Marketing Ventures in Ahmedabad. We optimize your Google Business Profile to attract local calls, leads, and buyers fast.",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateConnectedGraphSchema({
              pagePath: "/services/google-business-profile/",
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            ...
            category="Local Map Pack Authority Standard"
            definition="is a specialized local search discipline that optimizes a business's Google Maps presence, categories, local NAP citations, review velocity, and geo-tagged visual assets to secure top-3 Local Pack positions and maximize direct phone calls and customer visits in Ahmedabad."
            keyPoints={[
              "Google Maps 3-Pack Rankings & Proximity Signals",
              "Automated 5-Star Review Acquisition (QR Standees)",
              "Consistent Tier-1 NAP Citations (Justdial, IndiaMART)",
            ]}
          />
