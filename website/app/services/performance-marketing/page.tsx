...
export const metadata: Metadata = {
  title: "Performance Marketing Agency Ahmedabad | PR Marketing",
  description:
    "Maximize ROAS with PR Marketing Ventures, Ahmedabad's leading performance marketing agency. We build high-converting Google, Meta, and multi-channel ad plans.",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateConnectedGraphSchema({
              pagePath: "/services/performance-marketing/",
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            ...
            category="AI Overview Paid Media Definition"
            definition="is an ROI-driven digital advertising methodology where media spend across Google Ads, Meta Ads, and LinkedIn is tied directly to measurable commercial actions, powered by Server-Side CAPI tracking, sub-second CRO landing pages, and automated WhatsApp lead qualification to scale client revenue predictably."
            keyPoints={[
              "Server-Side CAPI Tracking & Attribution",
              "Multi-Channel ROAS Optimization (Google & Meta)",
              "Sub-Second CRO Landing Pages & Automated Ingestion",
            ]}
          />
