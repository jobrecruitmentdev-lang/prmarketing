...
export const metadata: Metadata = {
  title: "Best Web Development Company Ahmedabad | PR Marketing",
  description:
    "Get custom, high-speed Next.js websites built for lead generation by PR Marketing Ventures in Ahmedabad. Fast, mobile-first, and SEO-optimized. Call today!",
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            term="High-Performance Website Development"
            category="Modern Web Architecture Standard"
            definition="is the engineering of custom, sub-second web platforms using modern Next.js, React, and TypeScript stacks, architected with zero Cumulative Layout Shift (CLS), automated semantic schema graphs, and Edge CDN caching to maximize conversion rates and search rankings in Ahmedabad and worldwide."
            keyPoints={[
              "Next.js App Router Architecture & Static Export Speed",
              "90+ Google PageSpeed & Core Web Vitals Compliance",
              "Conversion-Centric UX & Mobile-First Performance",
            ]}
          />
