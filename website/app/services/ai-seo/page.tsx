...
export const metadata: Metadata = {
  title: "AI SEO & GEO Agency Ahmedabad | PR Marketing Ventures",
  description:
    "Get cited in ChatGPT, Perplexity, and Google AI Overviews with PR Marketing Ventures in Ahmedabad. Lead the future of generative search engine ranking today!",
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            term="Generative Engine Optimization (GEO / AEO)"
            category="AI Engine Citation Standard"
            definition="is the strategic engineering of brand entities, semantic schema graphs, structured definition blocks, and authoritative web consensus to ensure a business is directly cited, summarized, and recommended by ChatGPT, Google AI Overviews, Perplexity AI, Claude, and Gemini."
            keyPoints={[
              "Structured Extraction Blocks (#definition-block)",
              "Multi-Entity DefinedTermSet & Wikidata Mapping",
              "High-Authority AI Knowledge Graph Feeds (llms.txt)",
            ]}
          />
