...
export const metadata: Metadata = {
  title: "Ecommerce Development Agency Ahmedabad | PR Marketing",
  description:
    "Scale online sales with PR Marketing Ventures, the top ecommerce agency in Ahmedabad. We build fast Shopify and Next.js stores and run profitable ad campaigns.",
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            term="Ecommerce Website Development"
            category="High-Conversion Store Engineering Standard"
            definition="is the technical development of ultra-fast online storefronts using headless Next.js, Shopify, and WooCommerce platforms, engineered with sub-second checkout speeds, frictionless UPI/payment integrations, automated inventory synchronization, and Google Merchant schema to scale online transactions in Ahmedabad and globally."
            keyPoints={[
              "Headless Next.js, Shopify & WooCommerce Scaling",
              "Sub-Second Mobile Checkout & UPI Payment Integration",
              "Automated Product & MerchantListing Structured Data",
            ]}
          />
