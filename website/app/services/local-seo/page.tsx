...
export const metadata: Metadata = {
  title: "Local SEO Services Ahmedabad | Rank #1 on Google Maps",
  description:
    "Capture nearby high-intent customers with local SEO services by PR Marketing Ventures in Ahmedabad. Boost your local rankings, map visibility, and calls now!",
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            term="Local SEO"
            category="Google Local 3-Pack & Proximity Standard"
            definition="is the technical optimization of a business's local search presence across Google Search and Google Maps, combining localized landing page schema, geo-grid ranking signals, Tier-1 citation consistency, and automated review velocity to drive high-intent phone inquiries and foot traffic in Ahmedabad."
            keyPoints={[
              "Google Maps 3-Pack Ranking & Geo-Grid Coverage",
              "Tier-1 Local NAP Synchronization (B-903 Consistency)",
              "High-Conversion Localized Schema & Review Generation",
            ]}
          />
