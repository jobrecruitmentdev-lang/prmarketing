...
export const metadata: Metadata = {
  title: "Custom Software Development Ahmedabad | PR Marketing Co",
  description:
    "Build robust SaaS, web portals, and custom software systems with PR Marketing Ventures in Ahmedabad. Scalable cloud architectures engineered for business ROI.",
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-primary-soft via-white to-white">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 md:pt-24">
          ...
          <AeoDefinitionCard
            term="Custom Software Development"
            category="Enterprise Software Architecture Standard"
            definition="at PR Marketing Ventures is an engineering discipline that designs, develops, and deploys high-performance web applications, scalable SaaS platforms, custom CRM systems, and cloud API microservices using modern Next.js, Node.js, and Python FastAPI stacks for enterprises in Ahmedabad and globally."
            keyPoints={[
              "Next.js, Node.js & Python FastAPI Microservices",
              "Enterprise Cloud Security & Sub-Second Response Times",
              "Custom CRM, ERP & Workflow Automation Portals",
            ]}
          />
