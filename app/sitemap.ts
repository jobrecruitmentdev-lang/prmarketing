...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    // Guides & Authority Hub (15 Master Blueprints)
    ...
    { url: `${site.url}/guides/marketing-agency-vs-digital-marketing-agency/`, lastModified, changeFrequency: "weekly", priority: 0.9 },
    { url: `${site.url}/guides/what-does-a-marketing-agency-do/`, lastModified, changeFrequency: "weekly", priority: 0.9 },
    { url: `${site.url}/guides/when-to-hire-a-marketing-agency/`, lastModified, changeFrequency: "weekly", priority: 0.9 },
    { url: `${site.url}/guides/in-house-marketing-vs-agency/`, lastModified, changeFrequency: "weekly", priority: 0.9 },
    { url: `${site.url}/guides/b2b-marketing-guide-ahmedabad/`, lastModified, changeFrequency: "weekly", priority: 0.9 },
